 ...
 *P5.JS Of My Indiviual Data Portrait. Personal Communication Data I Collected. Each Different Platform Is A Different Colour. You Can Click Or Hover Above A Specific Data Point To See All Of The Other Data Points Also In The Same Category. Movement Of The Particles Are Random And Have No Meaning.*
 ...
 *Infographic Generated by NotebookLM*
 ...
 The layouts for the representations all follow a straightforward top to bottom or left to right hierarchy typical of a report structure. I didn't need to override or redirect much, because NotebookLM had the customisation options built directly into the interface as sidebar buttons. To get the output close to what I was envisioning, NotebookLM walked me through several structured choices: language, orientation, and visual style (selected from options including auto, sketchnote, kawaii, professional, scientific, anime, clay, editorial, instructional, bento grid, and bricks, I chose kawaii for the infographic). It also asked for a level of detail across three ascending options: concise, standard, and detailed. There was also a freetext comment box where I could specify things like which data points to highlight, preferred colours, or custom titles. One assumption worth questioning is that the AI framed everything as a growth story. Titles like 'Casino Resilience' and 'The Rise of Lotteries' sound positive, but these same trends could just as easily be read as warning signs depending on who's looking at the data. It could simply be the AI summarising what it observed in the data, that New Zealanders are spending more on gambling over time but that interpretation isn't clearly reflected in the titles it chose.
