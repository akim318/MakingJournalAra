...
### How Would You Develop Further With More Time?
 I would make the data portrait digital rather than physical, as keeping and paper based portrait up to date was difficult. I had to manually record every data point, which made it easy to forget and update regularly. 
...
## Reflective Proposal 
### My Reflection
 During the weeks we have spent in class and outside of class experimenting with different techonologies, I really liked using the 



### Defining A Thematic Focus
...
### Independent Study 
 ...
 Here is what I discovered with the help of NotebookLM:
